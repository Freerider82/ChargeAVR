...
*/
/*______________________макросы дл€ работы с 16 разр€дными регистрами _____________________________*/
/*______________________чтение  _____________________________*/
#define  GET_16BIT_RG(var,PORT)			do{(var) |= (PORT##L)|((PORT##H)<<8);}while(0)
#define  SET_16BIT_RG(PORT, var)			do{(PORT##H)=(var)>>8; (PORT##L)=(var);}while(0)
